...
Tlist = 0.01:0.01:pi*5;
alist = [0.0001, 0.15,0.3,0.5];
...
% ylabel('$W_\alpha^{N=\infty}(T)/\pi^2$','fontsize',myfont,'Interpreter','Latex')
...
% 
% XL=xlim; YL=ylim;
% text(0.91*(XL(2)-XL(1))+XL(1),0.94*(YL(2)-YL(1))+YL(1),'(a)','fontsize',22 , 'Interpreter','latex')
